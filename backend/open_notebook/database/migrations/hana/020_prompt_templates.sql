-- Migration: 020 - Prompt Templates (HANA)
...
CREATE UNIQUE INDEX idx_prompt_templates_role ON agent_prompt_templates(role);

-- ============================================================================
-- SEED DATA
-- ============================================================================

INSERT INTO agent_prompt_templates (id, role, name, description, prompt_text, default_prompt_text, is_default, created, updated)
VALUES (
