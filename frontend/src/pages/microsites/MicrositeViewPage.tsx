    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Button variant="ghost" size="sm" onClick={() => navigate("/microsites")}>
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            onClick={() => navigate(`/microsites/${micrositeId}/edit?mode=visual`)}
          >
          ...
          <Button
            variant="outline"
            onClick={() => navigate(`/microsites/${micrositeId}/edit?mode=code`)}
          >
            <Pencil className="w-4 h-4 mr-2" />
            Edit (Code)
          </Button>
