...
interface BarChartProps extends Omit<ChartConfig, "type"> {
    ...
    <div className="w-full clear-both my-4 mb-8">
      <Card className="w-full bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-md">
        ...
        <CardContent className="pt-6 pb-6">
          ...
          <RechartsBar data={data} stackOffset={stacked ? "expand" : undefined} margin={{ top: 10, right: 30, left: 20, bottom: 90 }}>
