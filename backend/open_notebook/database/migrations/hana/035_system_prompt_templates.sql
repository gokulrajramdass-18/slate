-- Migration: 035 - System Prompt Templates (HANA)
...
CREATE COLUMN TABLE system_prompt_templates (
    ...
    default_prompt_text NCLOB NOT NULL,
    variables NCLOB,
    metadata NCLOB,
...
-- Seed all 28 system prompt templates

INSERT INTO system_prompt_templates (id, category, template_key, name, description, prompt_text, default_prompt_text, variables, metadata, is_default, is_active, created, updated)
VALUES (
