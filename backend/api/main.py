...
# app.include_router(sap_ai_core_sdk_import.router)  # SAP AI Core SDK import endpoint (with credentials) - DISABLED: Use proxy instead
app.include_router(sap_ai_core_proxy.router)  # SAP AI Core proxy (no credentials needed)
